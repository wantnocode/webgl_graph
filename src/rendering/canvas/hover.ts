...
export default function drawHover(
  ...
  data: PartialButFor<NodeDisplayData, "x" | "y" | "size" | "label" | "color" | "icon" | "isRenderBox">,
  settings: Settings,
): void {
  ...
  if (typeof data.label === "string" && data.isRenderBox === true) {
  ...
  // let img = new Image();
  // img.src = "http://localhost:8000/img/icon/IP.svg";
